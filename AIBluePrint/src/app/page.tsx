    ...
    <div>
      ...
      <section className="py-20 px-6 max-w-[860px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <p className="text-[13px] font-bold text-brand-500 uppercase tracking-wide mb-2">
              Starter
            </p>
            ...
            <p className="text-sm text-gray-500 mb-7">
              See your tool stack instantly. First full unlock included.
            </p>
            {freePlanFeatures.map((item) => (
              <div
                key={item}
                className="flex items-center gap-2.5 mb-3 text-gray-500 text-sm"
              >
          ...
          {/* Pro Tier */}
          <div className="bg-white border-2 border-brand-500 rounded-2xl p-8 relative shadow-[0_4px_20px_rgba(108,60,239,0.12)]">
      ...
      <section className="py-20 px-6 text-center bg-gray-50">
        ...
        <p className="text-base text-gray-500 mb-9 max-w-[480px] mx-auto">
          Preview is always free. First full unlock on us — no credit card required.
        </p>
        <Link href="/signup">
          <Button size="lg">
