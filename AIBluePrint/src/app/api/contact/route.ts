...
export async function POST(req: NextRequest) {
  ...
  const { name, email, phone, timeline, budget, message, additionalInfo, _honeypot } =
    payload;
  ...
  <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:16px;border:1px solid #e5e7eb;overflow:hidden;">
      ...
      <table style="width:100%;border-collapse:collapse;">
        ...
        ${
          message
            ? `<tr>
          <td style="padding:12px 0;border-bottom:1px solid #f3f4f6;vertical-align:top;">
            <span style="font-size:12px;font-weight:600;color:#9ca3af;text-transform:uppercase;letter-spacing:0.05em;">Message</span>
          </td>
          <td style="padding:12px 0;border-bottom:1px solid #f3f4f6;vertical-align:top;">
            <span style="font-size:14px;color:#111827;line-height:1.6;white-space:pre-wrap;">${message}</span>
          </td>
        </tr>`
            : ""
        }
    ...
    <div style="padding:20px 40px;background:#f9fafb;border-top:1px solid #e5e7eb;">
      <p style="margin:0;font-size:12px;color:#9ca3af;text-align:center;">
        Sent from AI Blueprint · <a href="https://www.aiblueprintapps.com" style="color:#7c3aed;text-decoration:none;">aiblueprintapps.com</a>
      </p>
    </div>
  </div>
</body>
